		...
		<div id="sub_contents" class="support_common">
            ...
            ?> 
                <table>
                    ...
                    <tr>
                        <th><label for="qna_email">이메일</label></th>
                        <td>
                            <?=$useremail?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <?
                                if($mode == "modify"){
                            ?>
                            <input type="text" name="subject" id="qna_title" value="<?=$item_subject?>" maxlength="100">
                            <?
                                }else{
                            ?>
                            <input type="text" name="subject" id="qna_title">
                            <?
                                }
                            ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <?
                               if($mode == "modify"){
                            ?>
                            <textarea name="content" id="qna_content" rows="20"><?=$item_content?></textarea>
                            <?
                                }else{
                            ?>
                            <textarea name="content" id="qna_content" rows="20"></textarea>
                            <?
                                }
                            ?>
                        </td>
                    ...
                    <tr>
                        <th>
                            <label for="qna_file01">첨부파일1</label>
                        </th>
                        <td colspan="3">
                            <input type="file" name="upfile[]" id="qna_file01">
                            <? 	
                    ...
                    <tr class="bottom">
                        <th>
                            <label for="qna_file02">첨부파일2</label>
                        </th>
                        <td colspan="3">
                            <input type="file" name="upfile[]" id="qna_file02">
                            <?	
                ...
                <div class="btn_wrap">
                    ...
                    <a href="qna.php?table=<?=$table?>&page=<?=$page?>#indicator" class="list_btn">목록</a>
                </div>
            </form>
		</div>
